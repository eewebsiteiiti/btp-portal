...
export default function DpgcUploads() {
  ...
  const handleFileUpload = (event: ChangeEvent<HTMLInputElement>, type: UploadType) => {
  ...
  const handleUpload = async (
    ...
    try {
      ...
      if (type === "student") {
        ...
        body = { data, sendEmails: sendStudentEmails, program: "MTP" };
      } else if (type === "professor") {
        endpoint = "/api/professor/create";
        body = { data, sendEmails: sendProfessorEmails };
      } else if (type === "project") {
        endpoint = "/api/project/create";
        body = { data, program: "MTP" };
      }
  ...
  const uploadCards: {
  ...
  }[] = [
    {
      type: "project",
      title: "MTP Projects",
      description: "Upload MTP project titles, domains (CSP/PSPE/VDN), supervisors",
    ...
    },
    {
      type: "professor",
      title: "Professors",
      description: "Upload professor names and emails (shared with BTP)",
    ...
    },
    {
      type: "student",
      title: "MTP Students",
      description: "Upload MTP students with domain column (CSP/PSPE/VDN)",
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Upload MTP Data</h1>
              ...
              {(type === "student" || type === "professor") && (
                <div className="flex items-center justify-between mt-4 p-3 bg-muted/50 rounded-lg">
                  ...
                  <Switch
                    ...
                    onCheckedChange={
                      type === "student"
                        ? setSendStudentEmails
                        : setSendProfessorEmails
                    }
                  />
                </div>
              )}
